...
import RouterEventEmitter from '@uniswap/v2-periphery/build/RouterEventEmitter.json'
import SpaceSwap from '../../build/mockSpaceSwap.json'
...
export async function v2Fixture(provider: Web3Provider, [wallet]: Wallet[]): Promise<V2Fixture> {
  ...
  const SpaceSwap_contract = await deployContract(wallet, SpaceSwap,[router02.address])
